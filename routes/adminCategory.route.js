...
import { addCategory, deleteCategory, editCategoryDetails, getAddCategory, getCategories, getEditCategory, listCategory, unlistCategory } from "../controllers/adminCategory.controller.js";
...
router.patch("/status/active/:id", requireAdminAuth, listCategory);

router.patch("/status/inactive/:id", requireAdminAuth, unlistCategory);
